        ...
        <div className="px-6 py-4 border-b border-black/10 dark:border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="relative flex items-center w-full sm:w-auto">
            ...
            <input
              ...
              className="pl-9 pr-8 py-2 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-[13px] text-gray-900 dark:text-white placeholder:text-gray-600 focus:border-executive-blue outline-none transition-all w-full sm:w-64 hover:border-black/20 dark:border-white/20"
            />
            {search && (
              <motion.button
